...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Inscription Employé</h1>
...
<div class="container">
    <!-- Formulaire d'inscription Employe -->
    <form method="post" action="inscriptionEmploye.php" id="form" enctype="multipart/form-data" autocomplete="on" novalidate>
        <fieldset>
            ...
            <div class="form-group row">
                <div class="col-md-4 mb-3">
                    <label for="siren"><span class="text-danger">*</span> Siren</label>
                    <input type="text" class="form-control" pattern="[0-9]{9}" maxlength="9" autocomplete="off" spellcheck="false" name="siren" id="siren" placeholder="Exemple: 123456789" required/>
                    <div class="valid-feedback">
                        Siren Ok !
                    </div>
                    <div class="invalid-feedback">
                        Le champ siren est obligatoire et doit faire 9 caractères
                    </div>
                </div> 
            </div>
            <div class="form-group row">
    ...
    <?php
        if (isset($_POST['submit'])) {
            ...
            if($_FILES) {
                ...
                if($motdepasse != $_POST['motdepasse2']) {
                    $ok = false;
                ...
                if ($ok) {
                    ...
                    try {
                        ...
                        $location = 'images/utilisateurs/employes/';
