                ...
                <div class="container px-4 px-lg-5 my-5">
                    <div class="row gx-4 gx-lg-5 align-items-center">
                        ...
                        <div class="col-md-10">
                            ...
                            $quantite_alert = $produitManager->getProduitByAlert($_GET['idproduit']);
                            
                            if (empty($quantite_alert)) {
                                echo '<div class="col-md-5"><p class="lead"><b>'.$value['quantite_produit'].'</b> en stock</p></div>';
                            } else if (!empty($quantite_alert)) {
                                echo '
                                    ...
                                    <div class="alert alert-warning d-flex align-items-center" role="alert">
                                        ...
                                        <div>
                                            Attention il ne reste que <b>'.$value['quantite_produit'].'</b> produits en stock !
                                        </div>
                                    </div>';
                            }
                            
                            echo '<div class="col-md-12"><h3 class="text-decoration-underline">Descrition du produits</h3><p>'.$value['description_produit'].'</p></div>
